...
set(ADAPTIVE_SUPPORTED_ARCH ${ALL_SANITIZER_COMMON_SUPPORTED_ARCH})
if(APPLE)
  list(APPEND ADAPTIVE_SUPPORTED_ARCH ${DARWIN_COMMON_ARCHS})
endif()
list_intersect(ADAPTIVE_SUPPORTED_ARCH
  ALL_ADAPTIVE_SUPPORTED_ARCH
  SANITIZER_COMMON_SUPPORTED_ARCH)
filter_available_targets(ADAPTIVE_SUPPORTED_ARCH ${ADAPTIVE_SUPPORTED_ARCH})