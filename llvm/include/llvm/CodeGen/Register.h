...
public:
  inline __attribute__((always_inline)) constexpr Register(unsigned Val = 0) : Reg(Val) {}  constexpr Register(MCRegister Val) : Reg(Val) {}
 ...
 inline __attribute__((always_inline)) static constexpr bool isPhysicalRegister(unsigned Reg) {    
  return MCRegister::isPhysicalRegister(Reg);
  }

  /// Return true if the specified register number is in
  /// the virtual register namespace.
 inline __attribute__((always_inline)) static constexpr bool isVirtualRegister(unsigned Reg) {    
  return Reg & MCRegister::VirtualRegFlag;
  }

  /// Convert a virtual register number to a 0-based index.
  /// The first virtual register in a function will get the index 0.
 inline __attribute__((always_inline)) static unsigned virtReg2Index(Register Reg) {    
  ...
  /// namespace.
 inline __attribute__((always_inline)) constexpr bool isVirtual() const { return isVirtualRegister(Reg); }
  /// Return true if the specified register number is in the physical register
  /// namespace.
 inline __attribute__((always_inline)) constexpr bool isPhysical() const { return isPhysicalRegister(Reg); }
  /// Convert a virtual register number to a 0-based index. The first virtual
  /// register in a function will get the index 0.
  unsigned virtRegIndex() const { return virtReg2Index(Reg); }

  inline __attribute__((always_inline)) constexpr operator unsigned() const { return Reg; }
  inline __attribute__((always_inline)) constexpr unsigned id() const { return Reg; }
  ...
  inline __attribute__((always_inline)) constexpr bool operator==(const Register &Other) const {    
