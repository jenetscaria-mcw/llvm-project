...
public:
  ...
  inline __attribute__((always_inline)) const TargetRegisterClass *getRegClass(unsigned i) const {    
...
struct VirtReg2IndexFunctor {
  ...
  inline __attribute__((always_inline)) unsigned operator()(Register Reg) const {    
