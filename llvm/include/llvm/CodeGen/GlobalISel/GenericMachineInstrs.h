...
public:
 ...
 inline __attribute__((always_inline)) Register getReg(unsigned Idx) const { return getOperand(Idx).getReg(); }
...
public:
 inline __attribute__((always_inline)) Register getCondReg() const { return getReg(1); } 
 inline __attribute__((always_inline)) Register getTrueReg() const { return getReg(2); } 
 inline __attribute__((always_inline)) Register getFalseReg() const { return getReg(3); }
  static bool classof(const MachineInstr *MI) {
...
public:
 inline __attribute__((always_inline)) CmpInst::Predicate getCond() const {    return static_cast<CmpInst::Predicate>(getOperand(1).getPredicate());
  }
 inline __attribute__((always_inline)) Register getLHSReg() const { return getReg(2); } 
 inline __attribute__((always_inline)) Register getRHSReg() const { return getReg(3); }
  static bool classof(const MachineInstr *MI) {
