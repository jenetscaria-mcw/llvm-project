...
public:
  ...
  __attribute__((always_inline)) unsigned getAddrSpace() const { return PtrInfo.getAddrSpace(); }
  ...
  __attribute__((always_inline)) LocationSize getSize() const {
  ...
  __attribute__((always_inline)) LocationSize getSizeInBits() const {
    return MemoryType.isValid()
  ...
  /// store occurs.
  __attribute__((always_inline)) AtomicOrdering getSuccessOrdering() const {
    return static_cast<AtomicOrdering>(AtomicInfo.Ordering);
  }

  /// For cmpxchg atomic operations, return the atomic ordering requirements
  /// when store does not occur.
  __attribute__((always_inline)) AtomicOrdering getFailureOrdering() const {
  ...
  __attribute__((always_inline)) AtomicOrdering getMergedOrdering() const {
