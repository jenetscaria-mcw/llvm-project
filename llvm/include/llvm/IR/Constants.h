...
public:
  ...
  inline __attribute__((always_inline)) int64_t getSExtValue() const { return Val.getSExtValue(); }
  ...
  inline __attribute__((always_inline)) bool equalsInt(uint64_t V) const { return Val == V; }
...
public:
  ...
  inline __attribute__((always_inline)) const APFloat &getValueAPF() const { return Val; }  inline const APFloat &getValue() const { return Val; }
