...
public:
  ...
  __attribute__((always_inline)) static bool track(Metadata *&MD) {
  ...
  __attribute__((always_inline)) static void untrack(Metadata *&MD) { untrack(&MD, *MD); }
...
struct AAMDNodes {
  __attribute__((always_inline)) explicit AAMDNodes() = default;
