...
[[nodiscard]] inline __attribute__((always_inline)) constexpr std::underlying_type_t<Enum> to_underlying(Enum E) {  return static_cast<std::underlying_type_t<Enum>>(E);
}
