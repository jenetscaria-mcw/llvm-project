...
template<> struct DenseMapInfo<unsigned> {
 ...
 inline __attribute__((always_inline)) static unsigned getHashValue(const unsigned& Val) { return Val * 37U; }
 inline __attribute__((always_inline)) static bool isEqual(const unsigned& LHS, const unsigned& RHS) {    return LHS == RHS;
  }
};
...
template<> struct DenseMapInfo<unsigned long> {
 ...
 inline __attribute__((always_inline)) static unsigned getHashValue(const unsigned long& Val) {    if constexpr (sizeof(Val) == 4)
