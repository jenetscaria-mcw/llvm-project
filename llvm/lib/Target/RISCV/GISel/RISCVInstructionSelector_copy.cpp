...
__attribute__((always_inline)) class RISCVInstructionSelector : public InstructionSelector {
public:
...
bool RISCVInstructionSelector::replacePtrWithInt(MachineOperand &Op,
                                                 ...
                                                 __attribute__((always_inline)) MachineRegisterInfo &MRI) {
...
bool RISCVInstructionSelector::isRegInGprb(Register Reg,
                                           __attribute__((always_inline)) MachineRegisterInfo &MRI) const {
...
__attribute__((always_inline)) static unsigned getFCmpOpcode(CmpInst::Predicate Pred, unsigned Size) {
...
static bool legalizeFCmpPredicate(Register &LHS, Register &RHS,
  ...
  __attribute__((always_inline)) auto isLegalFCmpPredicate = [](CmpInst::Predicate Pred) {
