...
#include "RISCVGenSubtargetInfo.inc"
  ...
  __attribute__((always_inline)) bool hasStdExtCOrZca() const { return HasStdExtC || HasStdExtZca; }
  ...
  __attribute__((always_inline)) bool hasConditionalMoveFusion() const {
  ...
  __attribute__((always_inline)) bool is64Bit() const { return IsRV64; }
  MVT getXLenVT() const {
    return is64Bit() ? MVT::i64 : MVT::i32;
  }
  __attribute__((always_inline)) unsigned getXLen() const {
  ...
  __attribute__((always_inline)) bool hasVInstructions() const { return HasStdExtZve32x; }
  __attribute__((always_inline)) bool hasVInstructionsI64() const { return HasStdExtZve64x; }
  __attribute__((always_inline)) bool hasVInstructionsF16Minimal() const { return HasStdExtZvfhmin; }
  __attribute__((always_inline)) bool hasVInstructionsF16() const { return HasStdExtZvfh; }
  __attribute__((always_inline)) bool hasVInstructionsBF16() const { return HasStdExtZvfbfmin; }
  __attribute__((always_inline)) bool hasVInstructionsF32() const { return HasStdExtZve32f; }
  __attribute__((always_inline)) bool hasVInstructionsF64() const { return HasStdExtZve64d; }
  // F16 and F64 both require F32.
  __attribute__((always_inline)) bool hasVInstructionsAnyF() const { return hasVInstructionsF32(); }
  __attribute__((always_inline)) bool hasVInstructionsFullMultiply() const { return HasStdExtV; }
