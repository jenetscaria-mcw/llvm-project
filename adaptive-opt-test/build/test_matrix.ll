; ModuleID = 'test-programs/test_matrix.cpp'
...
define dso_local noundef i32 @main() #2 {
  ...
  %12 = call noalias noundef nonnull ptr @_Znam(i64 noundef 10000) #10
  store ptr %12, ptr %3, align 8
  %13 = call noalias noundef nonnull ptr @_Znam(i64 noundef 10000) #10
  store ptr %13, ptr %4, align 8
  %14 = call noalias noundef nonnull ptr @_Znam(i64 noundef 10000) #10
...
42:                                               ; preds = %39
  ...
  %44 = call i64 @_ZNSt6chrono3_V212system_clock3nowEv() #11
  ...
  %50 = call i64 @_ZNSt6chrono3_V212system_clock3nowEv() #11
...
104:                                              ; preds = %95
  call void @_ZdaPv(ptr noundef %102) #12
  br label %105
...
108:                                              ; preds = %105
  call void @_ZdaPv(ptr noundef %106) #12
  br label %109
...
112:                                              ; preds = %109
  call void @_ZdaPv(ptr noundef %110) #12
  br label %113
...
declare void @print_performance_summary() #4
